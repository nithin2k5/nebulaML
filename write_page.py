...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-indigo-500/30 selection:text-indigo-200 font-sans overflow-x-hidden relative scroll-smooth">
      ...
      {/* Global CSS for custom animations added via style tag since we can't easily edit globals.css from here securely without parsing it */}
...
with open("client/src/app/home/page.js", "w") as f:
    f.write(content)
