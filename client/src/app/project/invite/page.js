        ...
        <Card className="w-full max-w-md bg-zinc-950/80 border-white/10 shadow-2xl backdrop-blur-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-zinc-400 mt-2">
              You must be logged in to accept this invitation. If you don't have an account, please create one first.
            </CardDescription>
          </CardHeader>
        ...
        <CardHeader className="text-center pt-8">
          ...
          <CardDescription className="text-zinc-400 text-base mt-2">
            {status === 'success' ? 'You have successfully joined the project. Redirecting...' : 
             ...
             "You've been invited to collaborate on a NebulaML dataset. Accept below to join."}
          </CardDescription>
        </CardHeader>
